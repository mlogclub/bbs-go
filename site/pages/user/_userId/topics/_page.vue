          ...
          <div class="main-body">
            <nav class="breadcrumb" aria-label="breadcrumbs" style="margin-bottom: 10px;">
              <ul>
                ...
                <li><a :href="'/user/'+ user.id +'?tab=topics'">{{ user.nickname }}</a></li>
                <li class="is-active">
            ...
            <pagination :page="topicsPage.page" :url-prefix="'/user/'+ user.id +'/topics/'" />
          </div>
        </div>
...
export default {
  components: {
    TopicList, Pagination, UserCenterSidebar
  },
  computed: {
  // 是否是主人态
    isOwner: function () {
