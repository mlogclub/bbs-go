...
func (this *subjectContentRepository) Query(db *gorm.DB, queries *simple.ParamQueries) (list []model.SubjectContent, paging *simple.Paging) {
	queries.StartQuery(db).Find(&list)
    queries.StartCount(db).Model(&model.SubjectContent{}).Count(&queries.Paging.Total)
