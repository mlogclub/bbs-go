...
var (
	...
	adminPermissionRules = []adminPermissionRule{
		...
		{Method: "GET", Pattern: "/api/admin/topic-node/*", Permissions: []PermissionDefinition{PermissionNodeView}},
		{Method: "GET", Pattern: "/api/admin/topic-node/nodes", Permissions: []PermissionDefinition{PermissionNodeView}},
		{Method: "POST", Pattern: "/api/admin/topic-node/list", Permissions: []PermissionDefinition{PermissionNodeView}},
		{Method: "POST", Pattern: "/api/admin/topic-node/create", Permissions: []PermissionDefinition{PermissionNodeCreate}},
		{Method: "POST", Pattern: "/api/admin/topic-node/update", Permissions: []PermissionDefinition{PermissionNodeUpdate}},
		{Method: "POST", Pattern: "/api/admin/topic-node/delete", Permissions: []PermissionDefinition{PermissionNodeDelete}},
		{Method: "POST", Pattern: "/api/admin/topic-node/update_sort", Permissions: []PermissionDefinition{PermissionNodeSort}},
