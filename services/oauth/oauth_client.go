...
func GetOauthConfig() *oauth2.Config {
	config := &oauth2.Config{
		ClientID:     utils.Conf.OauthClientId,
		ClientSecret: utils.Conf.OauthClientSecret,
		RedirectURL:  utils.Conf.OauthClientRedirectUrl,
		Scopes:       []string{},
		Endpoint: oauth2.Endpoint{
			AuthURL:  utils.Conf.OauthAuthUrl,
			TokenURL: utils.Conf.OauthTokenUrl,
		},
	}
	return config
}
