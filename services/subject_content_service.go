...
import (
	...
	"github.com/mlogclub/mlog/common/subject"
...
func (this *subjectContentService) Query(queries *simple.ParamQueries) (list []model.SubjectContent, paging *simple.Paging) {
