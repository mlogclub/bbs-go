...
from OriginAgent.agent.tools.registry import (
    ...
    policy_rule_from_error_text,
    _requires_capability_snapshot,
    ToolRegistry,
)
...
class AgentRunner:
    ...
    async def _request_model(
        ...
        if timeout_s is None:
            ...
            # Set ORIGINAGENT_LLM_TIMEOUT_S=0 to disable.
            raw = os.environ.get("ORIGINAGENT_LLM_TIMEOUT_S", "300").strip()
            try:
                timeout_s = float(raw)
        ...
        # merely because total elapsed time exceeded ORIGINAGENT_LLM_TIMEOUT_S.
    ...
    async def _run_tool(
        ...
        try:
            ...
            await self._audit_tool_from_runner(
                ...
                tool=tool,
                params=params,
                status="policy_denied" if policy_rule else "error",
                start=start,
                error_kind=type(exc).__name__,
    ...
    def _policy_rule_from_error(text: str) -> str | None:
        return policy_rule_from_error_text(text)
