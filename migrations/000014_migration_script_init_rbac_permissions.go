...
var rbacPermissionSeeds = []permissions.PermissionDefinition{
	...
	permissions.PermissionNodeView,
	permissions.PermissionNodeCreate,
	permissions.PermissionNodeUpdate,
	permissions.PermissionNodeDelete,
	permissions.PermissionNodeSort,
