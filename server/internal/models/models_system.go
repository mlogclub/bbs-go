...
type Role struct {
	...
	Code       string `gorm:"uniqueIndex:idx_role_code" gorm:"size:64" json:"code" form:"code"` // 角色编码
...
type Menu struct {
	...
	Name       string `gorm:"size:256;uniqueIndex:idx_menu_name" json:"name" form:"name"` // 名称
