import { UserFollowedClientPage } from "@/components/user/user-profile-client-page"
...
export function meta({
  ...
  return userMeta(
    rootData?.config,
    data?.user,
    localizedTitle(rootData?.locale, "Following", "关注"),
    location.pathname
  )
}

export default UserFollowedClientPage
