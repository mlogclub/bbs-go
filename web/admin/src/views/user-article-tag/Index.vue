  ...
  export default {
    ...
    methods: {
      list() {
        ...
        HttpClient.post('/api/admin/user-article-tag/list', params)
          .then(data => {
      ...
      addSubmit() {
        let me = this
        HttpClient.post('/api/admin/user-article-tag/create', this.addForm)
          .then(data => {
      ...
      handleEdit(index, row) {
        let me = this
        HttpClient.get('/api/admin/user-article-tag/' + row.id)
          .then(data => {
      ...
      editSubmit() {
        let me = this
        HttpClient.post('/api/admin/user-article-tag/update', me.editForm)
          .then(data => {
            me.list()
