  ...
  <section>
    ...
    <el-dialog title="新增" :visible.sync="addFormVisible" :close-on-click-modal="false">
      <el-form :model="addForm" label-width="80px" :rules="addFormRules" ref="addForm">
        ...
        <el-form-item label="sourceUrl" prop="rule">
  ...
  export default {
    ...
    methods: {
      list() {
        ...
        HttpClient.post('/api/admin/article-share/list', params)
          .then(data => {
      ...
      addSubmit() {
        let me = this
        HttpClient.post('/api/admin/article-share/create', this.addForm)
          .then(data => {
      ...
      handleEdit(index, row) {
        let me = this
        HttpClient.get('/api/admin/article-share/' + row.id)
          .then(data => {
      ...
      editSubmit() {
        let me = this
        HttpClient.post('/api/admin/article-share/update', me.editForm)
          .then(data => {
            me.list()
